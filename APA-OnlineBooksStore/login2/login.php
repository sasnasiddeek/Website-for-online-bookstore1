<?php
  ...
  $sql="insert into register(IndexNo,fname,lname,user_pwd,email) VALUES 
  ('$IndexNo','$first','$last','$pwd','$email')";
			...
			<div class="wrap-login100">
				<form action="" method="POST" class="login100-form validate-form p-l-55 p-r-55 p-t-178">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate="Please enter username">
						<input class="input100" type="text" name="first" placeholder="first">
